...
def predict_reg(company_merged, starting_index, num_split, regressor):
...
def predict_class(company_merged, starting_index, num_split, classifier):
    data2 = company_merged[
